...
from lib.block import varNode

from lib.block import funcNode

from lib.block import arrayNode

from lib.block import Block

from lib.innerCode import InnerCode
...
class Praser:
    ...
    def praser_parameter_declaration(self, node, funcName, definite):
        ...
        if definite:
            ...
            newnode.num = self.innerCode.varNum
            self.innerCode.varNum = self.innerCode.varNum + 1
...
# TODO =======================================DIVIDE=======================================
    ...
    def praser_assignment_expression(self, assign_exp):
        ...
        if assign_exp.left.name == 'logical_or_expression':
            ...
            self.innerCode.addCode(self.innerCode.createCodeforAssign(node1, node3))
